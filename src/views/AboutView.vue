...
<template>
      ...
      <section
        ...
        <div class="flex flex-col md:flex-row items-center gap-6 w-full">
          <div class="flex justify-center">
            <img class="w-40 h-40 md:w-60 md:h-60 rounded-full border-4 border-amber-200 object-cover pict" src="img/foto.jpg" alt="Foto">
          </div>
          <div class="md:w-7/12">
            <p class="mb-3 md:mb-7 fadein-left fadeins-1">
              &nbsp; &nbsp; &nbsp; Halo, saya Nuzaim Birri, seorang Mahasiswa Teknik Informatika yang memiliki passion dalam menciptakan solusi digital yang interaktif, responsif, dan efisien. Saya terbiasa bekerja dengan teknologi front-end maupun back-end, serta selalu bersemangat untuk mempelajari hal baru di dunia pengembangan web.
            </p>
            <p class="mb-3 fadein-left fadeins-2">
              &nbsp; &nbsp; &nbsp; Saya membangun website yang fungsional, menarik, dan mudah digunakan.
              Dengan sentuhan personal, saya membantu menyampaikan pesan dan identitas Anda secara kreatif. 🚀
            </p>
          </div>
          <div class="flex flex-col items-center gap-3 md:w-1/4">
            ...
            <div class="relative flex flex-col items-center">
              <svg width="90" height="90" viewBox="0 0 90 90">
                <circle cx="45" cy="45" r="40" stroke="#fff" stroke-width="8" fill="#232323" />
                <circle cx="45" cy="45" r="40" stroke="#eab308" stroke-width="8" fill="none" stroke-dasharray="251.2" stroke-dashoffset="50" stroke-linecap="round" />
                <text x="50%" y="50%" text-anchor="middle" dy=".3em" font-size="1.7em" fill="#fff">3.50</text>
              </svg>
              <span class="text-xs mt-1 text-amber-200 font-semibold">Teknik Informatika</span>
              <span class="text-xs text-amber-200 font-bold">Universitas Lampung</span>
            </div>
          </div>
        </div>
      </section>
  ...
  <div class="fixed inset-0 flex items-center justify-between pointer-events-none z-40">
    <div class="pointer-events-auto">
      <SlideNav :prev="{ label: 'Home', path: '/' }" />
    </div>
    <div class="pointer-events-auto">
      <SlideNav :next="{ label: 'SWOT', path: '/swot' }" />
    </div>
  </div>
</template>
